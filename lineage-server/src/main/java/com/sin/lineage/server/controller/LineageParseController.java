...
public class LineageParseController {
    ...
    @PostMapping("/create")
    public Result<List<TableMeta>> parseCreateSql(@Validated @RequestBody CreateSqlReq req) {
        return Result.success(lineageParseService.parseCreateSql(req.getCreateSqlList()));
    }
